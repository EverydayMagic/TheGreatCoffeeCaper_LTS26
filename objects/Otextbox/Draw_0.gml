/*
	...
	{
		surface = surface_create(160, 144);	
	}
	...
	draw_sprite_ext(txtb_spr[page], txtb_img, _txtb_x - 1, _txtb_y, (textbox_width / txtb_spr_w), (textbox_height / txtb_spr_h), 0, c_white, 1); 
	...
	if (speaker_sprite[page] != noone) {
		...
		//draw the speaker
		draw_sprite_ext(sprite_index, speaker_imgindex[page], _speaker_x, (textbox_y + portrait_y_offset), speaker_side[page], 1, 0, c_white, 1);
	}
	...
	if (auto_move[page] = false)
	{
		if (draw_char = text_length[page] && !_optionified)
			if ((textbox_y = camera_get_view_y(VIEW) + 78) || down = true)
				draw_sprite_ext(Sarrow, arrow_ani, 143, 124, 1, 1, 0, c_white, 1);
			else
				draw_sprite_ext(Sarrow, arrow_ani, 143, 47, 1, 1, 0, c_white, 1);
	}
	...
	for (var c = 0; c < draw_char; c++) {
		...
		//the text
		draw_text_transformed_color((char_x[c, page] + _shake_x), (char_y[c, page] + _float_y + _shake_y), char[c, page], text_scale, text_scale, 0, color_1[c, page], color_2[c, page], color_3[c, page], color_4[c, page], 1);
		if (sprite_exists(inline_spr[c, page]))
		{
			draw_sprite_ext(inline_spr[c, page], 0, (char_x[c, page] + _shake_x), (char_y[c, page] + _float_y + _shake_y), 1, 1, 0, c_white, 1);
		}
	}
