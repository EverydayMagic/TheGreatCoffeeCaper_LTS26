...
InputIconDefineGamepad(INPUT_GAMEPAD_TYPE_SWITCH, -gp_axislv, "thumbstick l up"   );
InputIconDefineGamepad(INPUT_GAMEPAD_TYPE_SWITCH,  gp_axislv, "thumbstick l down" );
