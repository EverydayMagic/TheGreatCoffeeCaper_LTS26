function cut_mooshagain(){
	get_scene_cast(STORY_PACE.MOOSH_AGAIN);
	...
	global.moveOrder = [
		...
		[ create_textbox, ["mooshagain_1", moosh, true] ],
		[ costume_change, [moosh, moosh.idle_spr, 0] ],
		[ hold, [moosh, 0.5, "sec"] ],
		[ create_textbox, ["mooshagain_2", moosh, true] ],
		function(){
	...
	if (global.moveOrder_beat < array_length(global.moveOrder))
	{
		...
		if (!instance_exists(Otextbox))
		{
			...
			global.saveslot_story[global.saveslot][STORY_PACE.MOOSH_AGAIN] = 1;
